...
const Statistic: React.FC<StatisticProps> = (props) => {
  ...
  return (
    <div
      style={{ textAlign: "center", fontFamily: "IBM Plex Sans, sans-serif" }}
    >
      <h3 style={{ margin: 0, fontSize: "16px", color: "#000" }}>{title}</h3>
      {loading ? (
        <div
          style={{
            width: "100%",
            height: "10px",
            backgroundColor: "#e0e0e0", //Loading background light gray
            borderRadius: "0", //Right Angle
          }}
        />
      ) : (
        <div
